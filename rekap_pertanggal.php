...
<?php
// Jika ada pilihan kode kelas dan tanggal yang dipilih
if (isset($_GET['selected_kelas']) && isset($_GET['tanggal'])) {
    $selected_kelas = $_GET['selected_kelas'];
    $selected_date = $_GET['tanggal'];

    // Query untuk mendapatkan data absensi berdasarkan kode kelas dan tanggal yang dipilih
    $query_absensi = "SELECT absensi.kode_siswa, absensi.waktu, data_siswa.nama
                     ...
                     AND DATE(absensi.waktu) = '$selected_date'";
    ...
    if ($result_absensi->num_rows > 0) {
     ...
     // Hitung jumlah keterlambatan
        ...
        echo "Tidak ada data absensi untuk kode kelas ini pada tanggal tersebut.";
    }
}
