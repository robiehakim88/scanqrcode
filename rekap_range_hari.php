...
<body>
  ...
  <div class="container-fluid">
    ...
    if (isset($_GET['tanggal_awal']) && isset($_GET['tanggal_akhir'])) {
        ...
        // Query untuk mendapatkan data absensi berdasarkan rentang tanggal
        $query_absensi = "SELECT absensi.kode_siswa, absensi.waktu, data_siswa.nama
                         ...
                         WHERE DATE(absensi.waktu) BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
        ...
        if ($result_absensi->num_rows > 0) {
            ...
            echo "Tidak ada data absensi dalam rentang tanggal tersebut.";
        }
    }
